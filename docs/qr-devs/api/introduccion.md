...
Si eres un desarrollador integrando **QR Buho**, te recomendamos comenzar explorando la sección **[Tenant > Devices](./tenant/devices/qrapi-devices.info.mdx)** para entender cómo conectar una sesión de WhatsApp, y luego probar el **[Envío de Mensajes](./tenant/send_message/send-message.info.mdx)**.
